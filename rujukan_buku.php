...
if (isset($_POST['update_buku'])) {
    ...
    header("Location: rujukan_buku.php");
    exit();
}
...
<html>
<head>
    <title>Rujukan & Pengurusan Buku</title>
    ...
    <style>
        ...
        /* BUTANG RUJUK (USER) */
        .btn-rujuk { background: rgba(26, 188, 156, 0.25); border: 1px solid #1abc9c; color: #1abc9c; }
        .btn-rujuk:hover { background: #1abc9c; color: white; }
...
<div class="container">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $id; ?></td>
                <td style="text-align: left; max-width: 300px;"><?php echo $tj; ?></td>
                <td>
                ...
                <td>
                    <a href="borang_bacaan.php?buku_id=<?php echo $id; ?>" class="btn btn-rujuk" title="Rujuk & Baca">📚</a>
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <h3 style="color:#f39c12; text-align:center;">KEMAS KINI TAJUK</h3>
        <form method="POST">
            <input type="hidden" name="id_buku" id="edit_id">
            <input type="text" name="tajuk" id="edit_tajuk" required>
            <button type="submit" name="update_buku" class="btn btn-edit" style="width:100%; padding:10px;">SIMPAN PERUBAHAN</button>
        </form>
    </div>
</div>

<script>
// FUNGSI TOGGLE LIHAT PEMBACA
...
// FUNGSI SWEETALERT (DELETE/RESTORE)
...
// PAPAR POPUP BERJAYA (SWEETALERT)
